...
function CrownIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className="home-champion-crown">
      <path
        d="M4 18.5h16l-1.4-8.7-4.6 4.1L12 6.5 9.9 13.9 5.4 9.8 4 18.5Z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth="1.2"
...
export function HomeChampionBoard({ champions, locale }: Props) {
  ...
  return (
    <section className="home-champions home-champions-board" aria-labelledby="home-champions-title">
      <div className="home-champions-copy home-champions-copy-inline">
        <h2 id="home-champions-title">{copy.title}</h2>
        <p className="home-champions-inline-note">{copy.subtitle}</p>
      </div>
      <div
        ref={scrollerRef}
            ...
            return (
              ...
              >
                ...
                <div className="home-champion-body">
                  ...
                  <p className="home-champion-player" title={champion.playerName}>
                    <CrownIcon />
                    <span>{champion.playerName}</span>
                  </p>
