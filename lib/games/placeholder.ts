...
function createPlaceholderSvg(title: string) {
...
export function createPlaceholderThumbnail(title: string): UploadedFile {
  return {
    path: 'thumbnail.svg',
...
export function getPlaceholderThumbnailDataUrl(title: string) {
