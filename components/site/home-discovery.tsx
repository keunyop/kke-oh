...
import { HomeChampionsStrip } from '@/components/site/home-champions-strip';
...
export function HomeDiscovery({ initialQuery, games, champions, locale }: Props) {
  ...
  return (
    <>
      <HomeChampionsStrip champions={champions} locale={locale} />
