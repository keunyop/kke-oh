...
import { getAuthRepository, getFilesystemAuthRepository, validateCredentials } from '@/lib/auth/repository';
import { AUTH_COOKIE_NAME, getAuthCookieOptions, getSessionExpiryDate } from '@/lib/auth/session';
function shouldFallbackToFilesystem(error) {
...
async function createUserSession(user, repository) {
