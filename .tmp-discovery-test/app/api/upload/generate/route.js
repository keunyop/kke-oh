...
import { allocateGameId, createSingleHtmlInspection, prepareInspectionForPublishing, writeUploadedGame, writeUploadedGameToSupabase } from '@/lib/games/upload';
...
export async function POST(request) {
    try {
        ...
        const inspection = await prepareInspectionForPublishing(createSingleHtmlInspection(generated.html, generated.thumbnail), generated.title);
