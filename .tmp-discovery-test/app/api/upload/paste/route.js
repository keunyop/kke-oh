...
import { allocateGameId, createSingleHtmlInspection, createThumbnailUpload, prepareInspectionForPublishing, writeUploadedGame, writeUploadedGameToSupabase } from '@/lib/games/upload';
...
export async function POST(request) {
    try {
        ...
        const inspection = await prepareInspectionForPublishing(createSingleHtmlInspection(html, await createThumbnailUpload(thumbnail instanceof File ? thumbnail : null)), title);
