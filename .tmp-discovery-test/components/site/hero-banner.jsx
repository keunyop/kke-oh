...
export function HeroBanner({ title, description, href, imageUrl, badge, makerLabel, statLine }) {
    return (<section className="hero-banner">
      ...
      <div className="hero-art">
        {imageUrl ? (<Image src={imageUrl} alt={title} fill className="hero-image" priority unoptimized/>) : (<div className="hero-fallback" aria-hidden="true">
            <span>{title}</span>
          </div>)}
      </div>
    </section>);
